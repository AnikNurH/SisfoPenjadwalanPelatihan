    ...
    <div class="container body">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="clearfix"></div>
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="height:600px;">
                  ...
                  <form action="userupdate.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
				   <?php
			...
			<?php } ?>
			 <?php 
      // terima nip dari halaman datauser
      $nip = $_GET['nip'];
      ...
      ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name = "username" id="username" required="required" value="<?php echo $data['username'];?>" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">						
                        <a href = "datauser.php"><button type="button" name="cancel" class="btn btn-primary">Cancel</button></a/>
