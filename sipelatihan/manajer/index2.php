          ...
          <div class="">          	  
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <button type="submit" value="workshop  "class="btn btn-primary" Onclick="window.location.href='addindex2.php'">Add New</button>
                    </li>
                  </ul>
			...
			<tr class="<?php if ($i % 2 == 0) { echo "odd"; } else { echo "even"; } ?>">
				...
				<td>
					...
					<div class="row-actions">
						<a href="editindex2.php?id_workshop=<?php echo $data['id_workshop'];?>">Edit</a>
						 | <a href="index2delete.php?id_workshop=<?php echo $data['id_workshop'];?>" class="delete">Delete</a>
						 | <a href="detail-kegiatan.php?id_workshop=<?php echo $data['id_workshop'];?>">Detail</a>
					</div>
					<?php } ?>
				</td>
