          ...
          <div class="">          	  
              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <button type="submit" value="datastaff  "class="btn btn-primary" Onclick="window.location.href='adduser.php'">Add User</button>
                    </li>
                  </ul>
			...
			<tr class="<?php if ($i % 2 == 0) { echo "odd"; } else { echo "even"; } ?>">
				...
				<td>
					...
					<div class="row-actions">
						<a href="useredit.php?nip=<?php echo $data['nip'];?>">Edit</a>
						<?php if ($data['username'] != 'manajer') {?>
						 | <a href="userdelete.php?nip=<?php echo $data['nip'];?>" class="delete">Delete</a>
						<?php } ?>
					</div>
					<?php } ?>
				</td>
