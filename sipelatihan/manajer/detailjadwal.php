      ...
      ?>
					<div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="hidden" name = "id"  required="required" value="<?php echo $data['id_workshop'];?>" disabled class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name = "kegiatan" id="kegiatan" required="required" value="<?php echo $data['namakegiatan'];?>" disabled class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="date" name = "tglawal" id="tglawal" required="required" value="<?php echo $data['tgl_awal'];?>" disabled class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="date" name="tglakhir" value="<?php echo $data['tgl_akhir'];?>" disabled class="form-control col-md-7 col-xs-12" type="text">
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="kota" name="kota" value="<?php echo $data['kota'];?>" disabled class="form-control col-md-7 col-xs-12" type="text" >
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="provinsi" name="provinsi" value="<?php echo $data['provinsi'];?>" disabled class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                      </div>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="institusi" name="institusi" value="<?php echo $data['institusi'];?>" disabled class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                      </div>
                    </div>
					 <div class="form-group">
              ...
              ?>
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">						
                        <a href = "jadwalpelatihan.php"><button type="button" name="cancel" class="btn btn-primary">Cancel</button></a/>
